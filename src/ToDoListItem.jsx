    ...
    <div className="bg-green-300 item radius-[5px] shadow-lg shadow-dark-800 mt-[15px] p-[10px] pl-[20px]">
      ...
      <div className="item-actions">
        <button
          ...
          className="mr-[20px] outline outline-offset-4 outline-blue-500 rounded-[2px] cursor-pointer"
        >
          <PencilIcon className="w-5 h-5 text-blue-500" />
        </button>
        <button
          onClick={() => onDelete(index)}
          className="outline outline-offset-4 outline-red-500 rounded-[2px] cursor-pointer"
        >
